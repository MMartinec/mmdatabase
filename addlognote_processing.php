...
if ($_SERVER['REQUEST_METHOD']=='POST') {
	...
	*/
	$query = "INSERT INTO logNotes (date, staffstarttime, staffendtime, totalhoursworked, location, activityprogress, jobpreparation, jobdevelopment, jobcoaching, recordkeeping, paid, volunteer, otherpathway) VALUES ('".$_POST['date']."', '".$_POST['starttime']."', '".$_POST['endtime']."', '".$_POST['totalhoursworked']."', '".$_POST['location']."', '".$_POST['clientgoal']."', '".$_POST['jobprep']."', '".$_POST['jobdev']."', '".$_POST['jobcoachinghrs']."', '".$_POST['recordkeep']."', '".$_POST['paid']."', '".$_POST['volunteer']."', '".$_POST['otherpathway']."'	)";
	mysql_query($query);
/*
