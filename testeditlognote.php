...
<div class="content"><!--begin content-->
  ...
  <form enctype="multipart/form-data" action="editlognote_processing.php" method="POST"class="form-inline" role="form">
...
<div class="row">
  ...
  <div class="form-group">
    ...
    <input type="number" class="form-control" id="totalhoursworked" placeholder="Total Hours Worked">
  </div>
  </form>
...
<div class="row">
    ...
    <form cenctype="multipart/form-data" action="addlognote_processing.php" method="POST"lass="form" role="form">
  <div class="form-group">
    <label class="sr-only" for="newlognote">new log note</label>
    <textarea class="form-control" rows= "10" id="clientgoal" placeholder="Enter new log note"></textarea>
  </div>
 ...
 <div class="row">
  ...
  <h5>Job Preparation</h5>
    ...
    <input type="number" class="form-control" id="jobprep" placeholder="Enter hours">
  </div>
  
  <div class="form-group">
  <h5>Job Development</h5>
    <label class="" for="jobdev"></label>
    <input type="number" class="form-control" id="jobdev" placeholder="Enter hours">
  </div>
  
  <div class="form-group">
  <h5>Job Coaching</h5>
    <label class="" for="jobcoachinghrs"></label>
    <input type="number" class="form-control" id="jobcoachinghrs" placeholder="Enter hours">
  </div>
  
  <div class="form-group">
  <h5>Record Keeping</h5>
    <label class="" for="recordkeep"></label>
    <input type="number" class="form-control" id="recordkeep" placeholder="Enter hours">
  </div>
 ...
 <div class="row">
  ...
  <h5>Paid</h5>
    <label class="" for="jobprep"></label>
    <input type="number" class="form-control" id="paid" placeholder="Enter hours">
  </div>
  
  <div class="form-group">
  <h5>Volunteer</h5>
    <label class="" for="jobdev"></label>
    <input type="number" class="form-control" id="volunteer" placeholder="Enter hours">
  </div>
  ...
  <div class="otherpathform">
    ...
    <input type="number" class="form-control" id="otherpathway" placeholder="Enter hours">
  </div>
  </div>
  </form>
  ...
  <button type="button" name="submit" class="btn btn-default" value="submit">Submit</button>
