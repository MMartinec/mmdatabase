...
<div class="content"><!--begin content-->
 ...
 <div class="row">
            <div class="col-md-8 col-md-offset-3">
  <div class="Jobcoachname">
    <h4>Job Coach Name</h4>
    </div>
  </div>
 </div>
  ...
  <div class="row">
         ...
         <div class="jcnameinput"> 
                <form enctype="multipart/form-data" action="addjobcoach_processing.php" method="POST" class="form-inline" role="form">
  <div class="form-group">
    <label class="sr-only" for="firstname">Job Coach First Name</label>
    <input type="text" class="form-control" name="firstname"id="firstname" placeholder="First Name">
  </div>
  
  <div class="form-group">
    <label class="sr-only" for="lastname">Job Coach Last Name</label>
...
<!-- Job Coach Email****************************-->
  <div class="row">
            <div class="col-md-8 col-md-offset-3">  
  <div class="Jobcoachemailh4">
    <h4>Job Coach Email</h4>
    </div>
  </div>
 </div>
  ...
  <div class="row">
         ...
         <div class="jcemailinput"> 
                <form enctype="multipart/form-data" action="addjobcoach.php" method="POST" class="form-inline" role="form">
  <div class="form-group">
    <label class="sr-only" for="jobcoachemail">Job Coach Email</label>
...
<div class="row">
  ...
  <div class="row">
            <div class="col-md-8 col-md-offset-3">
            <div class="assignclientdropdown">
